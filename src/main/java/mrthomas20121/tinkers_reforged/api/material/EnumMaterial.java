...
public enum EnumMaterial implements EnumData {
    ...
    ETRYX(5, false, ORDER_END, EnumMaterialPalette.ETRYX, EnumMaterialStats.ETRYX, TinkersReforgedModifiers.otherworldy, EnumFluid.ETRYX, "End Metal material.", "When you hit an entity, summon spiders to attack it."),
