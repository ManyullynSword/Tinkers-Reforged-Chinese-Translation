...
public enum EnumMaterial implements EnumData {
    ...
    ETRYX(5, false, ORDER_END, EnumMaterialPalette.ETRYX, EnumMaterialStats.ETRYX, TinkersReforgedModifiers.diffusing, EnumFluid.ETRYX, "End Metal material.", "Distribute your mining speed stat to other stats(dmg, atk speed and durability)."),
